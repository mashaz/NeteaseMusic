...
def GetTopAllTime(uid):   #todo : csrf_token ? api ?
    pass     
...
def main():
    ...
    if len(sys.argv) == 1:#对比我喜欢的
            ...
            ulikedplaylist = GetAllListId('97948467')[0]
        ...
        if sys.argv[1].startswith('--'):     
            ...
            if (option == 'help'):
                ...
                print 
                print UseStyle('2. python compare.py -a #a for all songlists',fore='cyan')
                print  
                print UseStyle('3. python compare.py -i #i for input your name' ,fore='cyan')
                print  
                print UseStyle('4. python compare.py -ai',fore='cyan')
                print  
        elif sys.argv[1].startswith('-'): 
                option = sys.argv[1][1:] 
                if(option == 'a'):#对比所有歌单
                    iplaylist = GetAllListId('41977865')
                    uplaylist = GetAllListId('97948467')
